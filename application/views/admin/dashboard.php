...
<!--four-grids here-->
		<div class="four-grids">
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon fa fa-flag" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3>Brands</h3>
								<?php if(!empty($brands)): ?>
									<?php $total = count($brands); endif; ?>
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							<div class="icon">
								<i class="glyphicon fa fa-product-hunt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3>Products</h3>
								<?php if(!empty($products)): ?>
									<?php $total = count($products); endif; ?>
								<h4><?php echo $total; ?></h4>
...
<div class="copyrights">
	 <p>© 2020 Outlookmobiles. All Rights Reserved </a> </p>
</div>	
